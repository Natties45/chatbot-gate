...
import { Settings, GitBranch, Users, LogOut, ChevronDown, ChevronUp, RefreshCw, AlertTriangle, Plus, Edit, Trash2 } from 'lucide-react';
...
export default function SettingsPage() {
  ...
  const handleSaveAgentSettings = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess('Settings saved and synced to opencode successfully!');
      fetchSettingsAndConfig();
    } catch (err: any) {
